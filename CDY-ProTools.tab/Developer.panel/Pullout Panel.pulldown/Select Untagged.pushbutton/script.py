...
# __revit__ and __uidoc__ are injected by _exec_script in startup.py
uidoc = __uidoc__
if not uidoc:
    forms.alert("No active document.", title="Select Untagged")
    raise SystemExit
...
if not view:
    forms.alert("No active view.", title="Select Untagged")
    raise SystemExit

# ------------------------------------------------------------
# STEP 1: Get all taggable model categories in the view
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# STEP 4: Collect all tags in active view
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# STEP 5: Find and select untagged elements
# ------------------------------------------------------------
...
uidoc.Selection.SetElementIds(List[ElementId](untagged_ids))
